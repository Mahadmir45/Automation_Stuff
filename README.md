...
1. `embedded-test-automation` - Embedded API/device test automation with pytest + docs pipeline.
2. `cloud-governance-suite` - AWS governance automation and compliance reporting with boto3.
